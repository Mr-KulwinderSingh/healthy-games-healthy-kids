...
The Images were found bigger in size in the lighthouse report and then corrected accordingly same was for the header on the services page found small and suggested to turn to h2 was also corrected. it was also showing semantic errors due to the sequential order of headers. The errors which were not fixed I will look at them in future.
