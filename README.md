...
-   ### Design
    ...
    -   #### Fonts
        -  Only one Font is used for heading and the whole text contents of the website. Nato serif Lao font is the main font used throughout the whole website with Sans Serif as the fallback font in case for any reason the font isn't being imported into the site correctly. This font is generated by fonts.google.com, font Nato serif Lao is a clean font used frequently in programming, so it is both attractive and appropriate.
