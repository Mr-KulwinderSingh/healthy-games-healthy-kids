...
-   ### Design
    ...
    -   #### Colour Scheme
     The colours are used in the website to maintain the design and graphical structures, as well contrast between the background and foreground colours.
        -   
            #252525 (used for the headings),
            <br>
            #3a3a3a (used for body), 
            <br>
            rgb(95, 61, 244)(used for box-shadow),
            <br>
            ...
            <br>
            blue colour for the border of the buttons
            <br>
    ...
    -   #### Fonts
    <br>
    -  Only one Font is used for the heading and for the whole text contents of the website. 
    "Nato serif Lao" is the main font and "Sans Serif" is the fallback font in the case for any reason the font isn't being imported into the site correctly. "Nato serif Lao" is a clean & suitable font.

    <br>
    -  This font is generated by [Google fonts](https://fonts.google.com).   
    ...
    <br>
    -   The social media icons have been taken from 
...
-   This website contains a Home page, Services and Contact us page. 

<br>

-    "An effort to help children grow both healthier both physically and mentally" is a welcome heading and connects the interest of the user search for further information about it.

-   Easy navigation and links are there on all the pages. Hover effect on the Our-story and Why-do-we-exist, highlight the text for the user to build more  interest and keep connected with the impressive background colour. It also provides more clarity and visibility.<b>
...
-   The Lighthouse report was an effective tool to use and find out what errors were found. 
The Images were found bigger in size in the lighthouse report and then corrected accordingly same was for the header on the services page found small and corrected. it was also showing semantic errors due to the sequential order of headers. The errors which were not fixed I will look at them in future.
